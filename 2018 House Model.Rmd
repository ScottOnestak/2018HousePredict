...
```{r read in data file}
options(scipen=999)
theData = read.csv("C:/Users/onest/Desktop/2018 House Model/Data Files/Dataset20181015.csv")
...
train = modeldata[,c(8,14,28,31,33:35,38,40,41,43,48,54,56,58,59,60,63,65,66,68,73,79,81,83:88,92,93,96,97,99,100,102,113,121:123,128,131,133,138:141)]
test = currTest[,c(8,14,28,31,33:35,38,40,41,43,48,54,56,58,59,60,63,65,66,68,73,79,81,83:88,92,93,96,97,99,100,102,113,121:123,128,131,133,138:141)]
...
test_results = h2o.predict_leaf_node_assignment(ensemble, newdata = test)
leaves = as.data.frame(test_results)
